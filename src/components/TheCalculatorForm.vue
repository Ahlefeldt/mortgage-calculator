...
<template>
  <div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden p-6" data-testid="calculator-form">
    <BaseToggle v-model="gracePeriod" label="Afdragsfrihed" description="Angiv, om din realkredit har en afdragsfri periode" />
    <CalculatorTermSelector v-if="!gracePeriod" class="mt-6 pt-6 border-t border-gray-700" v-model:years="years" v-model:months="months" />
